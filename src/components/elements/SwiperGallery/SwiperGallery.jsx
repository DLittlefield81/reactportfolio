...
const wordpress = [
    {
        ...
        title: "TaqueriaLaUnion.mx",
        image: Images.taquerialaunion,
        alt: "Taqueria La Union",
        tech: "WordPress",
        role: "Sole Developer",
        description: "Restaurant website, Multilingual (Es, En), ",
        repository: "#",
        deployed: "https://TaqueriaLaUnion.mx"
    },
    {
        group: Solo,
        colour: "#002B5B",
